...
async function Changelog (args, newVersion, from) {
  if (args.skip.changelog) return
  await runLifecycleScript(args, 'prechangelog')
  await outputChangelog(args, newVersion, from)
...
function outputChangelog (args, newVersion, from) {
  return new Promise((resolve, reject) => {
    ...
    }, context, { merges: null, path: args.path, from })
